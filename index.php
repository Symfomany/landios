...
<?php
    if (!empty($_GET['send']) && !empty($_POST) && isset($_POST["email"]) && !empty($_POST["email"])) {
...
<meta name|http-equiv="Formation iOS à Lyon, Formation XCode à Lyon, Formation Swift à Lyon" content="Formation iOS, Formation XCode, Formation Swift" />
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="profile" href="http://gmpg.org/xfn/11">

<title>Formation en développement iOS avec Swift à Lyon</title>

<meta name="title" content="Formation en développement iOS à Lyon">
<meta name="description" content="Formation de développeur d'application iOS à Lyon sur XCode et Swift pour iPhone avec XCode" />
...
<meta name="category" content="Formation iOS à Lyon sur Swift et XCode">
...
<meta name="generator" content="Formation iOS à Lyon sous XCode pour iPhones et Ipads">
                ...
                <div id="page-header" class="header-style-dark" data-imgready="true">
                    ...
                    <div class="remove-menu-padding header-wrapper header-uncode-block">
                        <div data-parent="true" class="vc_row gradient style-color-wayh-bg row-container with-parallax onepage-section has-dividers boomapps_vcrow"
                            ...
                            <div class="uncode-divider-wrap uncode-divider-wrap-bottom z_index_3 mobile-hidden" style="height: 320px;"
                            ...
                            <div class="row col-double-gutter triple-top-padding no-bottom-padding single-h-padding limit-width row-parent row-header"
                                ...
                                <div  class="row-inner cols-md-responsive">
                                    <div class="pos-bottom pos-center align_left align_center_mobile column_parent col-lg-12  col-md-100 single-internal-gutter">
                                                    ...
                                                    <div class="uncont">
                                                        <div class="row-internal row-container boomapps_vcrow">
                                                            <div class="row unequal row-child">
                                                                <div class="row-inner cols-md-responsive">
                                                                    <div class="pos-middle pos-center align_left align_center_mobile column_child col-lg-5  col-md-50 half-internal-gutter">
                                                                        <div class="uncol style-dark shift_y_neg_quad">
                                                                            <div class="uncoltable">
                                                                                <div class="uncell   no-block-padding">
                                                                                    <div class="uncont  mobile-top">
                                                                                        <div class="heading-text el-text">
                                                                                            <h1 id="concepts" class="font-762333 fontsize-338686 fontheight-179065 fontspace-111509 font-weight-800">
                                                                                                <span>Formation de Développement
                                                                                                    iOS à
                                                                                                    Lyon</span>
                                                                                            </h1>
                                                                                        </div>
                                                                                        ...
                                                                                        <div style="height: 120px;" class="empty-space empty-single">
                                                                                            <span class="empty-space-inner"></span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="pos-bottom pos-center align_left column_child col-lg-6  mobile-hidden col-md-50 single-internal-gutter">
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <img
                                                                                                                        ...
                                                                                                                        width="516"
                                                                                                                        height="806"
                                                                                                                        alt="Formation iOS à Lyon pour iPhone X">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                        ...
                        <div class="post-body">
                            <div class="post-content">
                                ...
                                <div data-parent="true" class="vc_row row-container boomapps_vcrow" style="z-index: 2;"
                                    ...
                                    <div class="row  quad-bottom-padding single-h-padding limit-width row-parent"
                                        data-imgready="true">
                                        <div class="row-inner">
                                            <div class="pos-middle pos-center align_center align_center_mobile column_parent col-lg-12  single-internal-gutter">
                                                            ...
                                                            <div class="uncont no-block-padding col-custom-width">
                                                                <div class="row-internal row-container boomapps_vcrow">
                                                                    <div class="row row-child">
                                                                        <div class="row-inner">
                                                                            <div class="pos-top pos-center align_center column_child col-lg-12  half-internal-gutter">
                                                                                <div class="uncol style-light">
                                                                                    <div class="uncoltable">
                                                                                        <div class="uncell  no-block-padding">
                                                                                            <div class="uncont">
                                                                                            ...
                                                                                            <div data-wow-delay="300ms" class="wow fadeInUp">
                                                                                                <a target="_blank"
                                                                                                    ...
                                                                                                    class="wow slideInUp custom-link btn btn-lg border-width-0 btn-accent btn-flat btn-icon-left"
                                                                                                ><i
                                                                                                ...
                                                                                                <a 
                                                                                                    ...
                                                                                                    class="wow slideInUp contactez custom-link btn btn-lg border-width-0 btn-accent btn-flat btn-icon-left"
                                                                                                    ><i
                                                                                                        class="material-icons"
                                                                                            ...
                                                                                            <div class="clear"></div>
                                                                                            <h4  data-wow-delay="800ms" class="wow fadeInUp" style="color: #888"><i>Prochaine session le 1<sup>er</sup> Janvier 2019</i></h4>
                            ...
                            <div class="text-center">
                                ...
                                <h3 data-wow-delay="500ms" style="margin: 15px;margin-bottom: 50px;" class="wow fadeInDown  font-762333 h1 fontheight-357766 fontspace-111509 font-weight-100">Apprendre
                                    à développer une application iOS déployée sur Apple
                                    Store</h3>
                                <div class="clear"></div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div data-parent="true" class="vc_row gradient style-color-wayh-bg row-container with-parallax has-dividers boomapps_vcrow"
                                ...
                                <div id="contactez-nous" class="row no-top-padding no-bottom-padding single-h-padding limit-width row-parent"
                                    data-imgready="true">
                                    <div class="row-inner">
                                        <div class="pos-middle pos-center align_center column_parent col-lg-12  half-internal-gutter">
                                            <div class="uncol style-light">
                                                <div class="uncoltable">
                                                    <div class="uncell ">
                                                        <div class="uncont no-block-padding col-custom-width"
                                                                                ...
                                                                                <div class="uncoltable">
                                                                                    <div class="uncell   no-block-padding">
                                                                                        <div class="uncont">
                                                                                            ...
                                                                                            <div class="heading-text el-text">
                                                                                                <h2 id="thx-remove" class="font-762333 h1 fontspace-111509 font-weight-800 text-color-xsdn-color">
                                                                                                    <span>Interessé
                                                                                                        par
                                                                                                        la
                                                                                                        formation ?
                                                            ...
                                                            <div class="row-internal row-container boomapps_vcrow">
                                                                <div class="row row-child">
                                                                    <div class="row-inner" >
                                                                        <div class="pos-top pos-center align_center column_child col-lg-12  single-internal-gutter">
                                                                            <div class="uncol style-light">
                                                                                <div class="uncoltable">
                                                                                    <div class="uncell   no-block-padding">
                                                                                        <div class="uncont">
                                                                                            <div role="form"
                                                                                                ...
                                                                                                <h2 id="thx" style="display:none" class="font-762333 h1 fontspace-111509 font-weight-800 text-color-xsdn-color">
                                                                                                    Votre message a bien été envoyé. <br /> Nous reviendrons vers vous le plus vite possible.
                                                                                                </h2>
                                                                                                <form
                                                                                                    action="/?send=true"
                                                                                                    method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="wow flipInX" id="map"></div>
        ...
        <div data-parent="true" class="vc_row style-color-rgdb-bg row-container  boomapps_vcrow"
            ...
            <div class="row double-top-padding double-bottom-padding single-h-padding limit-width row-parent"
                ...
                <div class="row-inner cols-md-responsive">
                                                ...
                                                <aside id="text-3" class="widget widget_text widget-container sidebar-widgets">
                                                    ...
                                                    <div class="textwidget">
                                                        <p>Copyright © 2018 - Digital Online est un centre
                                                            de formations digitales et mobiles sur iOS avec XCode et Swift 4.</p>
                                                    </div>
                                                </aside>
                                            </div>
                                        </div>
                    ...
                    <div class="pos-top pos-left align_left column_parent col-lg-3  tablet-hidden col-md-25 single-internal-gutter">
                        <div class="uncol style-dark">
                            <div class="uncoltable">
                                <div class="uncell   no-block-padding">
                                    <div class="uncont">
                    ...
                    <div class="pos-top pos-left align_left column_parent col-lg-3  col-md-33 single-internal-gutter">
                        <div class="uncol style-dark">
                            <div class="uncoltable">
                                <div class="uncell   no-block-padding">
                                    <div class="uncont">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-127028987-1"></script>
<script>
window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());

gtag('config', 'UA-127028987-1');
</script>
</body>
