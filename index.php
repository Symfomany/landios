...
<head>
    ...
    <title>Formation Digital iOS de Apple pour iPhone avec XCode</title>
   
    <meta name="title" content="Formation Digital iOS pour Apple iPhone avec XCode">
    <meta name="description" content="Formation Digital sur iOS Apple iPhone pour iPhone avec XCode" />
    <meta name="syndication-source" content="http://digital-online.fr">
    <meta name="original-source" content="http://digital-online.fr">
    <meta name="country" content="France">
    <meta name="state" content="Rhône-Alpes">
    <meta name="city" content="Lyon">
    <meta name="category" content="Formation iOS">
    ...
    <meta name="generator" content="Formation iOS sous XCode pour Apple iPhone">
    ...
    <link rel="stylesheet" id="uncode-custom-style-css" href="library/css/style-custom.css" type="text/css" media="all">
    <link rel="stylesheet" id="uncode-icons-css" href="library/css/uncode-icons.css" type="text/css" media="all">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">

    <link rel="canonical" href="http://digital-online.fr">
    <link rel="shortlink" href="http://digital-online.fr">
...
<body class="home page-template-default page page-id-72416 page-child parent-pageid-43938 logged-in admin-bar style-color-wayh-bg hormenu-position-left hmenu hmenu-position-right header-full-width main-center-align menu-mobile-animated menu-mobile-transparent menu-mobile-centered wc-zoom-enabled wpb-js-composer js-comp-ver-5.5.2 vc_responsive customize-support hide-scrollup"
                                ...
                                <div class="post-wrapper">
                                    <div class="post-body">
                                        <div class="post-content">
                                            ...
                                            <div data-parent="true" class="vc_row row-container has-dividers boomapps_vcrow"
                                                data-section="1">
                                        ...
                                        <div class="owl-carousel">
                                            <div style="width: 300px"> <img src="slider/app-calendar-min.jpg" /> </div>
                                            <div style="width: 300px"> <img src="slider/app-home-min.jpg" /> </div>
                                            <div style="width: 300px"> <img src="slider/app-navigation-min.jpg" />
                                            </div>
                                            <div style="width: 300px"> <img src="slider/app-profile-min.jpg" /> </div>
                                            <div style="width: 300px"> <img src="slider/app-signup-min.jpg" /> </div>
                                            <div style="width: 300px"> <img src="slider/app-shop-min.jpg" /> </div>
                                            <div style="width: 300px"> <img src="slider/app-login-min.jpg" /> </div>
                                        </div>
                                                    ...
                                                    <div class="wpb_widgetised_column wpb_content_element">
                                                        <div class="wpb_wrapper">
                                                            <aside id="recent-posts-5" class="widget widget_recent_entries widget-container sidebar-widgets">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <a href="https://docs.swift.org/swift-book/GuidedTour/GuidedTour.html">Documentation
                                                                            de Swift</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="https://swift.org/getting-started/">Getting
                                                                            Started on Swift</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="http://localhost:8888/wordpress/2017/03/22/inspired-by-clouds/">Api
                                                                            Design Guidelines</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="https://openclassrooms.com/fr/courses/1823851-apprenez-a-programmer-en-swift">Swift
                                                                            Tutorial OpenClassRoom</a>
                                                                    </li>
                                                                    <li>
                                                                        <a hreh="https://itunes.apple.com/us/book/swift-programming-language/id881256329?mt=11">Apple
                                                                            Swift Book</a>
                                                                    </li>
                                                                </ul>
                                                            </aside>
                                                    ...
                                                    <div class="wpb_widgetised_column wpb_content_element">
                                                        <div class="wpb_wrapper">
                                                            <aside id="recent-posts-5" class="widget widget_recent_entries widget-container sidebar-widgets">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <a href="https://openclassrooms.com/fr/courses/1823851-apprenez-a-programmer-en-swift">Apprendre
                                                                            Swift sur OpenClassRoom</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="https://openclassrooms.com/fr/courses/4206426-introduction-a-ios-plongez-dans-le-developpement-mobile">Introduction
                                                                            iOS sur OpenClassRoom</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="https://openclassrooms.com/fr/courses/2582746-developpez-votre-premiere-application-pour-ios">Développez
                                                                            votre première application pour iOS sur
                                                                            OpenClassRoom</a>
                                                                    </li>
                                                                    <li><a href="https://github.com/allenwong/30DaysofSwift">30
                        ...
                        <div class="row row-parent style-dark limit-width no-top-padding no-h-padding no-bottom-padding">
                            ...
                            <div class="uncell col-lg-6 pos-middle text-right">
                                <div class="social-icon icon-box icon-box-top icon-inline">
                                    <a href="https://www.facebook.com/undsgn/" target="_blank">
                                        <i class="fa fa-social-facebook"></i>
                                    </a>
                                </div>
                                <div class="social-icon icon-box icon-box-top icon-inline">
                                    <a href="https://twitter.com/undsgndotcom" target="_blank">
    ...
    <input id="_webhelper_source" type="hidden" value="{&quot;GUID&quot;:&quot;23638294411903663&quot;,&quot;SOURCE&quot;:&quot;mbs-1837&quot;,&quot;BRAND&quot;:&quot;MyShopcoupon&quot;}">
    ...
    <div class="overlay overlay-sequential style-dark style-dark-bg overlay-search" data-area="search" data-container="box-container">
        ...
        <div class="search-container">
            <form action="http://localhost:8888/wordpress/" method="get">
                <div class="search-container-inner">
                    <input type="search" class="search-field form-fluid no-livesearch" placeholder="Rechercher. . ."
                        value="" name="s" title="Recherche pour :">
    ...
    <div class="gdpr gdpr-privacy-preferences">
        <div class="gdpr-wrapper">
            <form method="post" class="gdpr-privacy-preferences-frm" action="http://localhost:8888/wordpress/wp-admin/admin-post.php">
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBbdCiAUiZiteBaEkTnCQa6jEZsuDFRgh8&callback=initMap">
    ...
    },
    {
        ...
        "stylers": [
            ...
            var contentString = `
                        ...
                        <img width="400px" height="180px" src="https://www.bird-office.com/media/cache/thumbPlaceImage/prod/place/salle-de-reunion-et-de-formation-au-coeur-du-quartier-d-affaires-de-la-part-dieu-1472808317.jpeg" />
